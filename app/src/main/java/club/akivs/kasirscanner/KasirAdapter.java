...
public class KasirAdapter extends RecyclerView.Adapter<KasirAdapter.ViewHolder> {
    ...
    private static final String TAG = KasirAdapter.class.getSimpleName();

    private List<TblKasir> slist;
    private KasirAdapterCallback mAdapterCallback;

    public KasirAdapter(List<TblKasir> list, KasirAdapterCallback adapterCallback) {
        this.slist = list;
    ...
    public ViewHolder onCreateViewHolder( ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_kasir,
                parent, false);
    ...
    public interface KasirAdapterCallback {
