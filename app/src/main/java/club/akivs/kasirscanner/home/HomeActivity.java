package club.akivs.kasirscanner.home;
...
import club.akivs.kasirscanner.MenuActivity;
...
public class HomeActivity extends AppCompatActivity
   ...
   // @BindView(R.id.toolbar)
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tvTotal.setText(FunctionHelper.convertRupiah(Double.valueOf(getTotal()),this,getString(R.string.sp_profil)));
        ...
        builder1.setPositiveButton(
                ...
                new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog, int id) {
                        ...
                        tvTotal.setText(FunctionHelper.convertRupiah(Double.valueOf(getTotal()),HomeActivity.this,getString(R.string.sp_profil)));
